        ...
        when (currentCategory) {
            ...
            EditCategory.COLOR_BALANCE -> {
                Column(
                    ...
                    Text(
                        text = "${stringResource(
                            R.string.edit_color_balance_red,
                        )}: ${(colorBalanceRed * 100).toInt()}%",
                        style = MaterialTheme.typography.bodySmall,
                        modifier = Modifier.padding(bottom = 4.dp),
                    )
                    Slider(
                    ...
                    Text(
                        text = "${stringResource(
                            R.string.edit_color_balance_green,
                        )}: ${(colorBalanceGreen * 100).toInt()}%",
                        style = MaterialTheme.typography.bodySmall,
                        modifier = Modifier.padding(bottom = 4.dp),
                    )
                    Slider(
                    ...
                    Text(
                        text = "${stringResource(
                            R.string.edit_color_balance_blue,
                        )}: ${(colorBalanceBlue * 100).toInt()}%",
                        style = MaterialTheme.typography.bodySmall,
                        modifier = Modifier.padding(bottom = 4.dp),
                    )
                    Slider(
