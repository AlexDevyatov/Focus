...
fun AiPreviewScreen(
    ...
    val shareHelperInstance =
        shareHelper ?: remember {
            ...
            coroutineScope.launch {
                ...
                if (intent != null) {
                    try {
                        ...
                        android.util.Log.e(
                            "AiPreviewScreen",
                            "Ошибка открытия диалога шаринга: ${e.message}",
                            e,
                        )
                    }
                }
        ...
        Box(
            ...
            when {
                ...
                uiState.processedBitmap != null -> {
                    ...
                    val bitmapToShow =
                        if (uiState.showOriginal && uiState.originalBitmap != null) {
