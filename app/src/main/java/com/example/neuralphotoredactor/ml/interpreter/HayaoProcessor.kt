        ...
        suspend fun processImage(
            ...
            withContext(Dispatchers.Default) {
                ...
                return@withContext try {
                    ...
                    android.util.Log.d(
                        "HayaoProcessor",
                        "Обработка изображения: ${originalWidth}x$originalHeight",
                    )
                    ...
                    val scaledBitmap =
                        if (originalWidth != MODEL_INPUT_SIZE || originalHeight != MODEL_INPUT_SIZE) {
                    ...
                    android.util.Log.d(
                        "HayaoProcessor",
                        "Обработка завершена: ${originalWidth}x$originalHeight",
                    )
                    finalBitmap
                } catch (e: Exception) {
