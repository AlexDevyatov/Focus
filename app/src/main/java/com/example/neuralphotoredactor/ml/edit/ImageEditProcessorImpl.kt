 ...
 */
class ImageEditProcessorImpl
    @Inject
    constructor() : ImageEditProcessor {
        ...
        private fun cropImage(
            ...
            return try {
                ...
                android.util.Log.e(
                    "ImageEditProcessor",
                    "Недостаточно памяти для обрезки изображения",
                    e,
                )
                null
            } catch (e: Exception) {
        ...
        private fun adjustBrightness(
            ...
            return try {
                ...
                android.util.Log.e(
                    "ImageEditProcessor",
                    "Ошибка коррекции яркости: ${e.message}",
                    e,
                )
                null
            }
        ...
        private fun adjustContrast(
            ...
            return try {
                ...
                android.util.Log.e(
                    "ImageEditProcessor",
                    "Ошибка коррекции контраста: ${e.message}",
                    e,
                )
                null
            }
         ...
         */
        private fun adjustColorBalance(
            bitmap: Bitmap,
            red: Float,
            green: Float,
            blue: Float,
            ...
            return try {
                ...
                android.util.Log.e(
                    "ImageEditProcessor",
                    "Ошибка настройки цветового баланса: ${e.message}",
                    e,
                )
                null
            }
        ...
        private fun applyColorMatrix(
            ...
            return try {
                ...
                android.util.Log.e(
                    "ImageEditProcessor",
                    "Ошибка применения ColorMatrix: ${e.message}",
                    e,
                )
                null
            }
