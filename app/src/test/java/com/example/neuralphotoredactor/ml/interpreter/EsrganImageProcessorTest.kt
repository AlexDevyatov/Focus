...
class EsrganImageProcessorTest {
    ...
    @Test
    fun `processImage should return null when bitmap is recycled`() = runTest {
        // Given
        val bitmap = createTestBitmap()
        bitmap.recycle()
    ...
    @Test
    fun `processImage should validate patch size compatibility`() = runTest {
        // Given
    ...
    @Test
    fun `processImage should handle different filter types`() = runTest {
        // Given
        val bitmap = createTestBitmap()
    ...
    @Test
    fun `processImage should handle very small bitmap`() = runTest {
        // Given
    ...
    @Test
    fun `processImage should handle very large bitmap`() = runTest {
        // Given
    ...
    @Test
    fun `processImage should handle different bitmap configs`() = runTest {
        // Given
    ...
    @Test
    fun `processImage should handle exceptions gracefully`() = runTest {
        // Given
        val bitmap = createTestBitmap()
    ...
    @Test
    fun `processImage should handle square bitmap`() = runTest {
        // Given
    ...
    @Test
    fun `processImage should handle portrait bitmap`() = runTest {
        // Given
    ...
    @Test
    fun `processImage should handle landscape bitmap`() = runTest {
        // Given
