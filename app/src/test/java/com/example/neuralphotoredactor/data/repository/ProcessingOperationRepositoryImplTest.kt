...
class ProcessingOperationRepositoryImplTest {
    ...
    @Test
    fun `getOperationsBySessionId should return mapped operations`() =
        runTest {
            // Given
            val sessionId = 1L
    ...
    @Test
    fun `getOperationById should return mapped operation`() =
        runTest {
            // Given
            val historyId = createTestHistory()
            val filterId = createTestFilter()
    ...
    @Test
    fun `getLastOperationBySessionId should return mapped operation`() =
        runTest {
            // Given
            val sessionId = 1L
            val historyId = createTestHistory()
    ...
    @Test
    fun `getLastOperationBySessionId should return null when not found`() =
        runTest {
            // Given
            val sessionId = 999L
    ...
    @Test
    fun `addOperation should insert and return id`() =
        runTest {
            // Given
            val historyId = createTestHistory()
            val filterId = createTestFilter()
    ...
    @Test
    fun `deleteOperation should delete from dao`() =
        runTest {
            // Given
            val historyId = createTestHistory()
            val filterId = createTestFilter()
    ...
    @Test
    fun `deleteOperationsBySessionId should delete from dao`() =
        runTest {
            // Given
            val sessionId = 1L
            val historyId = createTestHistory()
