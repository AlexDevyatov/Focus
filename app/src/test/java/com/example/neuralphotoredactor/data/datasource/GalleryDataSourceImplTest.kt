...
class GalleryDataSourceImplTest {
    ...
    @Test
    fun `invalidateCache should clear cache`() =
        runTest {
            // When
    ...
    @Test
    fun `getAllImages should return empty list when cursor is null`() =
        runTest {
            // Given
    ...
    @Test
    fun `getAllImages should return empty list on SecurityException`() =
        runTest {
            // Given
            every {
    ...
    @Test
    fun `getAllImages should return images from cursor`() =
        runTest {
            // Given
    ...
    @Test
    fun `getAllImages should handle exception`() =
        runTest {
            // Given
            every {
                contentResolver.query(any(), any(), any(), any(), any())
    ...
    @Test
    fun `getImagesPaginated should return empty list when cursor is null`() =
        runTest {
            // Given
            every { contentResolver.query(any(), any(), any(), any(), any()) } returns null
    ...
    @Test
    fun `getImagesPaginated should return empty list on SecurityException`() =
        runTest {
            // Given
            every {
                contentResolver.query(any(), any(), any(), any(), any())
    ...
    @Test
    fun `getImagesPaginated should return paginated images`() =
        runTest {
            // Given
            ...
            assertTrue(
                result.isEmpty(),
            ) // Если не удалось переместиться, должен вернуться пустой список
        }

    @Test
    fun `getImagesPaginated should handle exception`() =
        runTest {
            // Given
            every {
                contentResolver.query(any(), any(), any(), any(), any())
    ...
    @Test
    fun `getImageCount should return 0 when cursor is null`() =
        runTest {
            // Given
            every { contentResolver.query(any(), any(), any(), any(), any()) } returns null
    ...
    @Test
    fun `getImageCount should return 0 on SecurityException`() =
        runTest {
            // Given
            every {
                contentResolver.query(any(), any(), any(), any(), any())
    ...
    @Test
    fun `getImageCount should return count from cursor`() =
        runTest {
            // Given
    ...
    @Test
    fun `getImageCount should return 0 on exception`() =
        runTest {
            // Given
            every {
                contentResolver.query(any(), any(), any(), any(), any())
