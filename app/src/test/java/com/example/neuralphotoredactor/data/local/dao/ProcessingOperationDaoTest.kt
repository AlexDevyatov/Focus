...
class ProcessingOperationDaoTest {
    ...
    @Test
    fun `getOperationsBySessionId should return operations sorted by sequenceNumber`() = runTest {
        // Given
        val historyId = createTestHistory()
        val filterId = createTestFilter()
        val sessionId = 1L

        val op1 = ProcessingOperationEntity(
            id = 0,
            historyId = historyId,
            sessionId = sessionId,
            filterId = filterId,
        ...
        val op2 = ProcessingOperationEntity(
            id = 0,
            historyId = historyId,
            sessionId = sessionId,
            filterId = filterId,
        ...
        val op3 = ProcessingOperationEntity(
            id = 0,
            historyId = historyId,
            sessionId = sessionId,
            filterId = filterId,
    ...
    @Test
    fun `getOperationsBySessionId should return only operations for specified sessionId`() = runTest {
        // Given
        val historyId = createTestHistory()
        val filterId = createTestFilter()
    ...
    @Test
    fun `getOperationsBySessionIdSuspend should return operations sorted by sequenceNumber`() = runTest {
        // Given
        val historyId = createTestHistory()
        val filterId = createTestFilter()
        val sessionId = 1L
    ...
    @Test
    fun `getOperationsByHistoryId should return empty list when no operations`() = runTest {
        // Given
        val historyId = createTestHistory()
    ...
    @Test
    fun `getOperationsByHistoryId should return operations sorted by sequenceNumber`() = runTest {
        // Given
    ...
    @Test
    fun `getOperationsByHistoryIdSuspend should return operations sorted by sequenceNumber`() = runTest {
        // Given
        val historyId = createTestHistory()
        val filterId = createTestFilter()
    ...
    @Test
    fun `getOperationById should return operation when found`() = runTest {
        // Given
        val historyId = createTestHistory()
        val filterId = createTestFilter()
    ...
    @Test
    fun `getLastOperationBySessionId should return last operation by sequenceNumber`() = runTest {
        // Given
        val historyId = createTestHistory()
        val filterId = createTestFilter()
        val sessionId = 1L
    ...
    @Test
    fun `getLastOperationBySessionId should return null when no operations`() = runTest {
        // When
    ...
    @Test
    fun `getMaxSequenceNumber should return 0 when no operations`() = runTest {
        // When
    ...
    @Test
    fun `getMaxSequenceNumber should return maximum sequenceNumber for sessionId`() = runTest {
        // Given
        val historyId = createTestHistory()
        val filterId = createTestFilter()
        val sessionId = 1L
    ...
    @Test
    fun `insert should insert operation and return generated id`() = runTest {
        // Given
        val historyId = createTestHistory()
        val filterId = createTestFilter()
    ...
    @Test
    fun `insertAll should insert multiple operations`() = runTest {
        // Given
        val historyId = createTestHistory()
        val filterId = createTestFilter()
    ...
    @Test
    fun `delete should remove operation from database`() = runTest {
        // Given
        val historyId = createTestHistory()
        val filterId = createTestFilter()
    ...
    @Test
    fun `deleteById should remove operation by id`() = runTest {
        // Given
        val historyId = createTestHistory()
        val filterId = createTestFilter()
    ...
    @Test
    fun `deleteBySessionId should remove all operations for sessionId`() = runTest {
        // Given
        val historyId = createTestHistory()
        val filterId = createTestFilter()
