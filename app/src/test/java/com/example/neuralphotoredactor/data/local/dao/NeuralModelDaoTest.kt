...
class NeuralModelDaoTest {
    ...
    @Test
    fun `getAllActiveModels should return empty list when database is empty`() = runTest {
        // When
    ...
    @Test
    fun `getAllActiveModels should return only active models sorted by name`() = runTest {
        // Given
        val activeModel1 = NeuralModelEntity(
            id = 0,
            name = "Z_Model",
            type = "STYLE_TRANSFER",
            version = "1.0",
        ...
        val activeModel2 = NeuralModelEntity(
            id = 0,
            name = "A_Model",
        ...
        val inactiveModel = NeuralModelEntity(
            id = 0,
            name = "Inactive_Model",
            type = "FILTER",
            version = "1.0",
    ...
    @Test
    fun `getAllActiveModels should return empty list when no active models`() = runTest {
        // Given
        val inactiveModel = NeuralModelEntity(
            id = 0,
            name = "Inactive_Model",
    ...
    @Test
    fun `getAllModels should return all models including inactive sorted by name`() = runTest {
        // Given
        val activeModel = NeuralModelEntity(
            id = 0,
            name = "Z_Active",
            type = "STYLE_TRANSFER",
            version = "1.0",
    ...
    @Test
    fun `getModelsByType should return empty list when no models of type`() = runTest {
        // When
    ...
    @Test
    fun `getModelsByType should return only active models of specified type`() = runTest {
        // Given
        val activeModel1 = NeuralModelEntity(
            id = 0,
            name = "Style_Model_1",
        ...
        val otherTypeModel = NeuralModelEntity(
            id = 0,
            name = "Super_Res",
            type = "SUPER_RESOLUTION",
            version = "1.0",
    ...
    @Test
    fun `getModelById should return model when found`() = runTest {
        // Given
    ...
    @Test
    fun `getModelByName should return model when found`() = runTest {
        // Given
        val model = NeuralModelEntity(
            id = 0,
            name = "Unique_Model",
    ...
    @Test
    fun `getModelByName should be case sensitive`() = runTest {
        // Given
        val model = NeuralModelEntity(
            id = 0,
            name = "TestModel",
    ...
    @Test
    fun `insert should insert model and return generated id`() = runTest {
        // Given
        val model = NeuralModelEntity(
            id = 0,
            name = "New_Model",
    ...
    @Test
    fun `insert should replace existing model when id matches`() = runTest {
        // Given
        val model = NeuralModelEntity(
            id = 0,
            name = "Original_Model",
        ...
        val updatedModel = NeuralModelEntity(
            id = id,
            name = "Updated_Model",
            type = "SUPER_RESOLUTION",
            version = "2.0",
    ...
    @Test
    fun `insertAll should insert multiple models`() = runTest {
        // Given
        val models = listOf(
            NeuralModelEntity(
                id = 0,
    ...
    @Test
    fun `update should update existing model`() = runTest {
        // Given
        val model = NeuralModelEntity(
            id = 0,
            name = "Original_Model",
    ...
    @Test
    fun `delete should remove model from database`() = runTest {
        // Given
        val model = NeuralModelEntity(
            id = 0,
    ...
    @Test
    fun `deleteById should remove model by id`() = runTest {
        // Given
        val model1 = NeuralModelEntity(
            id = 0,
            name = "Model_1",
            type = "STYLE_TRANSFER",
            version = "1.0",
    ...
    @Test
    fun `deleteById should not throw when deleting non-existent id`() = runTest {
        // When/Then - не должно быть исключения
        dao.deleteById(999L)
    }

    @Test
    fun `setActive should activate model`() = runTest {
        // Given
        val model = NeuralModelEntity(
            id = 0,
            name = "Inactive_Model",
    ...
    @Test
    fun `setActive should deactivate model`() = runTest {
        // Given
        val model = NeuralModelEntity(
            id = 0,
            name = "Active_Model",
    ...
    @Test
    fun `setActive should not affect other fields`() = runTest {
        // Given
        val model = NeuralModelEntity(
            id = 0,
            name = "Test_Model",
