...
class FilterDaoTest {
    ...
    @Test
    fun `getAllFilters should return empty list when database is empty`() =
        runTest {
            // When
    ...
    @Test
    fun `getAllFilters should return all filters sorted by name ascending`() =
        runTest {
            // Given
            val filter1 =
                FilterEntity(
    ...
    @Test
    fun `getAllFilters should return filters with and without modelId`() =
        runTest {
            // Given
    ...
    @Test
    fun `getFilterById should return filter when found`() =
        runTest {
            // Given
            val filter =
                FilterEntity(
    ...
    @Test
    fun `getFilterById should return filter with modelId when found`() =
        runTest {
            // Given
            val modelId = createTestModel()
            val filter =
    ...
    @Test
    fun `getFilterById should return null when not found`() =
        runTest {
            // When
    ...
    @Test
    fun `getFilterByName should return filter when found`() =
        runTest {
            // Given
            val filter =
                FilterEntity(
    ...
    @Test
    fun `getFilterByName should return filter with modelId when found`() =
        runTest {
            // Given
            val modelId = createTestModel()
            val filter =
    ...
    @Test
    fun `getFilterByName should return null when not found`() =
        runTest {
            // When
    ...
    @Test
    fun `getFilterByName should be case sensitive`() =
        runTest {
            // Given
            val filter =
                FilterEntity(
    ...
    @Test
    fun `insert should insert filter and return generated id`() =
        runTest {
            // Given
            val filter =
                FilterEntity(
    ...
    @Test
    fun `insert should insert filter with modelId`() =
        runTest {
            // Given
            val modelId = createTestModel()
            val filter =
    ...
    @Test
    fun `insert should replace existing filter when id matches`() =
        runTest {
            // Given
            val filter =
                FilterEntity(
    ...
    @Test
    fun `insertAll should insert multiple filters`() =
        runTest {
            // Given
            val filters =
                listOf(
    ...
    @Test
    fun `insertAll should insert filters with mixed modelId`() =
        runTest {
            // Given
            val modelId = createTestModel()
            val filters =
    ...
    @Test
    fun `insertAll should replace existing filters when ids match`() =
        runTest {
            // Given
            val filter1 =
                FilterEntity(
