...
class ProcessingHistoryDaoTest {
    ...
    @Test
    fun `getAllHistory should return empty list when database is empty`() = runTest {
        // When
    ...
    @Test
    fun `getAllHistory should return all history entries sorted by timestamp descending`() = runTest {
        // Given
        val entity1 = ProcessingHistoryEntity(
            id = 0,
            originalUri = "content://test/original1",
            processedUri = "content://test/processed1",
            timestamp = 1000L
        )
        val entity2 = ProcessingHistoryEntity(
            id = 0,
            originalUri = "content://test/original2",
            processedUri = "content://test/processed2",
            timestamp = 2000L
        )
        val entity3 = ProcessingHistoryEntity(
            id = 0,
    ...
    @Test
    fun `insert should insert entity and return generated id`() = runTest {
        // Given
    ...
    @Test
    fun `insert should replace existing entity when id matches`() = runTest {
        // Given
        val entity = ProcessingHistoryEntity(
            id = 0,
            originalUri = "content://test/original",
        ...
        val updatedEntity = ProcessingHistoryEntity(
            id = id,
    ...
    @Test
    fun `delete should remove entity from database`() = runTest {
        // Given
        val entity = ProcessingHistoryEntity(
            id = 0,
            originalUri = "content://test/original",
    ...
    @Test
    fun `deleteById should remove entity by id`() = runTest {
        // Given
        val entity1 = ProcessingHistoryEntity(
            id = 0,
            originalUri = "content://test/original1",
    ...
    @Test
    fun `findByUriAndTimestamp should return entity when found`() = runTest {
        // Given
    ...
    @Test
    fun `findByUriAndTimestamp should return null when not found`() = runTest {
        // When
    ...
    @Test
    fun `findByUriAndTimestamp should return null when uri matches but timestamp does not`() = runTest {
        // Given
        val entity = ProcessingHistoryEntity(
            id = 0,
            originalUri = "content://test/original",
    ...
    @Test
    fun `findByUriAndTimestamp should return null when timestamp matches but uri does not`() = runTest {
        // Given
        val timestamp = 1000L
        val entity = ProcessingHistoryEntity(
            id = 0,
    ...
    @Test
    fun `getHistoryById should return entity when found`() = runTest {
        // Given
        val entity = ProcessingHistoryEntity(
            id = 0,
            originalUri = "content://test/original",
